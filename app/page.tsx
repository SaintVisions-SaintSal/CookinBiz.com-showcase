        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="#ai" className="text-sm text-white/60 hover:text-white transition-colors">
                AI
              </Link>
              <Link href="#use-cases" className="text-sm text-white/60 hover:text-white transition-colors">
                Use Cases
              </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/auth/signup"
                className="px-4 py-2 bg-white text-black text-sm font-medium rounded-full hover:bg-white/90 transition-all"
              >
                Get Started
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="p-8 rounded-2xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 text-center">
              ...
              <div className="text-5xl md:text-6xl font-semibold text-green-400 mb-2">$1,491/mo</div>
              <div className="text-white/50 mb-6">Recurring passive income</div>
              <Link
